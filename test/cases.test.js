...
test("should resolve quotes in transform step", () => {
  return compare(
...
test("should stringify all values after ast transformation", () => {
  return compare(
    `
...
test("should warn on not found file", () => {
  return compare(
...
test("should add message about dependency", () => {
  return compare(
    `
    background: svg-load('fixtures/basic.svg');
...
test("should not add message about not found dependency", () => {
  return compare(
    `
    background: svg-load('fixtures/not-found.svg');
...
test("should add parent in dependency message if specified", () => {
  return compare(
    `
